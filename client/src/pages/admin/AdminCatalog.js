...
const AdminCatalog = () => {
  ...
  // Sample catalog data with more comprehensive information
  const sampleCatalogItems = [
    {
      ...
      denomination: '₹5',
      theme: 'personality',
      description: 'Special commemorative stamp celebrating 150 years of Mahatma Gandhi',
      ...
      orders: 45,
      featured: true,
      tags: ['gandhi', 'commemorative', 'personality', '150-years']
    },
    {
      id: '2',
      ...
      denomination: '₹10',
      theme: 'nature',
      description: 'Beautiful depiction of Kerala backwaters',
      ...
      orders: 23,
      featured: false,
      tags: ['kerala', 'backwaters', 'nature', 'scenic']
    },
    {
      id: '3',
      name: 'Railways Heritage Series',
      category: 'stamps',
      ...
      denomination: '₹15',
      theme: 'transport',
      description: 'Heritage railway stations and locomotives',
      image: '/images/stamps/railways-heritage.jpg',
      dateAdded: '2024-01-10',
      lastUpdated: '2024-01-22',
      views: 654,
      orders: 18,
      featured: true,
      tags: ['railways', 'heritage', 'transport', 'locomotives']
    },
    {
      id: '4',
      ...
      denomination: '₹20',
      theme: 'wildlife',
      description: 'Endangered species conservation awareness',
      image: '/images/stamps/wildlife-conservation.jpg',
      dateAdded: '2024-01-20',
      lastUpdated: '2024-01-22',
      views: 0,
      orders: 0,
      featured: false,
      tags: ['wildlife', 'conservation', 'endangered', 'awareness']
    },
    {
      id: '5',
      ...
      denomination: '₹8',
      theme: 'heritage',
      description: 'Mysore Palace architectural beauty',
      image: '/images/postcards/mysore-palace.jpg',
      dateAdded: '2024-01-08',
      lastUpdated: '2024-01-15',
      views: 432,
      orders: 12,
      featured: false,
      tags: ['mysore', 'palace', 'heritage', 'architecture']
    }
  ];
